...
CREATE TABLE `user` (
  ...
  `username` varchar(50) DEFAULT NULL COMMENT '用户名=姓名',
...
insert into `user` (`id`, `username`, `password`, `phone`, `status`, `level`) values('2','王慧','123456','1865299490','1','2');
insert into `user` (`id`, `username`, `password`, `phone`, `status`, `level`) values('20','刘维','123456','15850533159','1','2');
insert into `user` (`id`, `username`, `password`, `phone`, `status`, `level`) values('21','test','123456','test','1','3');
