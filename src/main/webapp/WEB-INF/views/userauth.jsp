							...
							<div class="widget-head am-cf">
								...
								<div class="widget-function am-fr">
									<div class="am-btn-group am-btn-group-xs">
										<a href="javascript:;" id="userAuthBtn"
											class="am-btn am-btn-default am-btn-success"
											style="color: #fff"> <span class="am-icon-plus"></span>
											提交
										</a>
									</div>
									<div class="am-btn-group am-btn-group-xs">
												...
												<c:forEach items="${userlist }" var="user" varStatus="s">
													<tr>
														<td><input type="checkbox" class="checkOne"  
															value="${user.id}"  ${user.ischecked?'checked':''}></td>
														<td>${user.username}</td>
														<td>${user.phone}</td>
			...
			$("#userAuthBtn").click(function(){
				...
				if(userIds.length==0){
					...
					$.ajax({
						...
						//它的含义是是否使用传统的方式浅层序列化
						traditional:true,
						data : {userIds:userIds, fileId:$("#hiddeFileID").val()},
