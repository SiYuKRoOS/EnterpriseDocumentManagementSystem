...
<script
	src="<%=request.getContextPath()%>/static/assets1/js/echarts.min.js"></script>
<link rel="stylesheet"
...
<body data-type="widgets">
					...
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
							<div class="widget-head am-cf">
								<div class="widget-title am-fl">编辑人员信息</div>
								...
								<form action="<%=request.getContextPath() %>/user/editUser" method="post" 
									...
									<div class="am-form-group">
										...
										<label for="user-name" class="am-u-sm-3 am-form-label">
											用户名 </label>
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input" value="${edituser.username}"
												name="username" required placeholder="请输入员工姓名"> <small>默认登录账号</small>
										</div>
									</div>
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="password" class="am-form-field tpl-form-no-bg"
												name="password" required value="${edituser.password }" placeholder="请输入密码 ">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="am-form-field tpl-form-no-bg"
												name="phone"  value="${edituser.phone }" placeholder="请输入手机号 ">
										</div>
									</div>
										...
										<div class="am-u-sm-9">
											<select name="level" data-am-selected="" style="display: none;">
												<c:forEach items="${levelEnums }" var="level">
													<option value="${level.id}" ${edituser.levelEnum.id==level.id?'selected':''}>${level.name }</option>
												</c:forEach>
											</select>
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<div class="tpl-switch">
												<input type="hidden" name="status" value="${edituser.statusEnum.id}">
												
												<input type="checkbox"
													class="ios-switch bigswitch tpl-switch-btn" ${edituser.statusEnum.id==1?'checked':''} >
									...
									<div class="am-form-group">
										<div class="am-u-sm-9 am-u-sm-push-3">
											...
											<a href="<%=request.getContextPath() %>/user/list"
												class="am-btn tpl-btn-bg-color-success">
	...
	<script
		src="<%=request.getContextPath()%>/static/assets1/js/amazeui.datatables.min.js"></script>
	<script
		src="<%=request.getContextPath()%>/static/assets1/js/dataTables.responsive.min.js"></script>
	<script src="<%=request.getContextPath()%>/static/assets1/js/app.js"></script>
	<script type="text/javascript">
		$(function(){
			$('.tpl-switch-btn').click(function () {
