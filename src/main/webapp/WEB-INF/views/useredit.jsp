					...
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
							...
							<div class="widget-body am-fr">
								...
								<form action="<%=request.getContextPath() %>/user/editUser" method="post" class="am-form tpl-form-border-form tpl-form-border-br">
									<div class="am-form-group">
										<input type="hidden" name="id" value="${edituser.id}">
										<label for="user-name" class="am-u-sm-3 am-form-label"> 用户名 </label>
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input" value="${edituser.username}" name="username" required placeholder="请输入员工姓名">
											<small>默认登录账号</small>
										</div>
									</div>
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="password" class="am-form-field tpl-form-no-bg" name="password" required value="${edituser.password }" placeholder="请输入密码 ">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="am-form-field tpl-form-no-bg" name="phone" value="${edituser.phone }" placeholder="请输入手机号 ">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<div class="tpl-switch">
												...
												<input type="checkbox" class="ios-switch bigswitch tpl-switch-btn" ${edituser.statusEnum.id==1?'checked':''}>
