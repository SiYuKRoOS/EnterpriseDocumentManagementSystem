...
.am-table>tbody>tr>td, .am-table>tbody>tr>th, .am-table>tfoot>tr>td,
	...
	.theme-black .tpl-table-black-operation a.tpl-table-black-operation-del, .theme-black .tpl-table-black-operation a{
		border: none;
		font-size: 16px;
	}
</style>
						...
						<div class="widget am-cf">
							<div class="widget-head am-cf">
								...
								<div class="widget-function am-fr">
									<button type="button"
										class="am-btn am-btn-default am-btn-success am-btn-xs"
										id="uploadBtn">
								...
								<form id="fileUploadForm" enctype='multipart/form-data'>
									<input id="fileUpload" type="file" name="file"
										multiplename="file" multiple style="display: none;" />
								</form>
										...
										<c:if test="${not empty filelist }">
											<c:forEach items="${filelist}" var="file" varStatus="s">
												<tr>
													...
													<td class="am-text-middle"><a
														href="<%=request.getContextPath() %>/${file.filepath}"
													...
													<td width="80" class="am-text-middle" style="text-align: center">
														<div class="tpl-table-black-operation">
															<c:if test="${from == 'upload'}">
																<a href="javascript:;" 
																	onclick="confirmDel(${file.id},'${file.filename }')"
																	class="tpl-table-black-operation-del"> <i
																	class="am-icon-trash"></i> 删除
																</a>
															</c:if>
															<c:if
																test="${from == 'download' and sessionScope.user.levelEnum.id ==1 }">
																<a href="javascript:;" 
																	onclick="confirmDel(${file.id},'${file.filename }')"
																	class="tpl-table-black-operation-del"> <i
																	class="am-icon-trash"></i> 删除
															...
															<a  style="margin-top: 6px;" 
																href="<%=request.getContextPath() %>/file/download?fileId=${file.id}">
