					...
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
							...
							<div class="widget-body am-fr">
								...
								<form action="<%=request.getContextPath() %>/user/editPwd" method="post" 
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="password" class="am-form-field tpl-form-no-bg"
												name="password" required value="${edituser.password }" placeholder="请输入新密码 ">
										</div>
									</div>
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="password" class="am-form-field tpl-form-no-bg"
												name="newPassword" required placeholder="请输入新密码 ">
										</div>
									</div>
									<div class="am-form-group">
