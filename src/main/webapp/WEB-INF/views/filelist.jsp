							...
							<div class="widget-body am-u-sm-12">
								  ...
								  <div class="am-u-sm-12 am-u-md-6 am-u-lg-3" style="padding: 0">
									<div
										...
										<input type="text" class="am-form-field" name="filename" value="${filename}"> <span
											...
											<c:forEach items="${filelist}" var="file" varStatus="s">
												<tr class="gradeX">
													...
													<td>		
														...
														<img src="<%=request.getContextPath() %>/static/assets1/img/file${file.filetype.id }.png"
														class="tpl-table-line-img" alt="${file.filetype }">
														${file.filetype }
														</span>
													</td>
													<td class="am-text-middle"><a href="<%=request.getContextPath() %>${file.filepath}" title="点击下载${file.filename }">${file.filename }</a></td>
													...
													<td class="am-text-middle">
														<div class="tpl-table-black-operation">
															<a href="<%=request.getContextPath() %>/file/download?fileId=${file.id}"> <i class="am-icon-download"></i>
																下载
															</a> 
															<c:if test="${from == 'upload'}">
																<a href="javascript:;" onclick="confirmDel(${file.id},'${file.filename }')"
