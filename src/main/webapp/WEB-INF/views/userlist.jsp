									...
									<div class="am-form-group am-fr">
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												<a href="<%=request.getContextPath()%>/user/toAddUser" class="am-btn am-btn-default am-btn-success">
								...
								<form action="<%=request.getContextPath()%>/user/search" method="post">
									...
									<div class="am-u-sm-12 am-u-md-6 am-u-lg-4" style="">
										<div class="am-form-group am-input-group-sm tpl-form-border-form cl-p">
											...
											<div class="am-u-md-8">
												<input type="text" placeholder="手机号" name="phone" value="${phone}">
											</div>
										</div>
									</div>
														...
														<td>
															<div class="tpl-table-black-operation">
																...
																<c:if test="${sessionScope.user.levelEnum.id==1}">
																	<a href="javascript:;" onclick="deleteUser(${user.id},'${user.username }')" class="tpl-table-black-operation-del">
